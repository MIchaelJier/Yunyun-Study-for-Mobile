...
_vue.default.component('yunSelect', yunSelect);
_vue.default.component('betterSticky', betterSticky);

_vue.default.component('uniList', uniList);
_vue.default.component('uniRate', uniRate);
